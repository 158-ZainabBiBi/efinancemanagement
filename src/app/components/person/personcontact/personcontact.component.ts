...
import { ContacttypeComponent } from '../../lookup/contacttype/contacttype.component';
...
export class PersoncontactComponent implements OnInit {
  ...
  load(reload): void {
    ...
    if (this.personcontactID != 0 && !this.personcontactID && Number(window.sessionStorage.getItem('personcontact')) > 0) {
      this.personcontactID = Number(window.sessionStorage.getItem('personcontact'));
    }
