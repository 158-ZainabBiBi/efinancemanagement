...
/*
  ...
  application_ID: "AcademicsManagement",

  companyName: 'Khuldunia Inistitute of Technology and Applied Sciences',
  companyShortName: 'KITAAS',
  logo: 'http://design.kitaas.edu.pk/images/logo.png',
  logo1white: 'http://design.kitaas.edu.pk/images/logo-short.png',
  loginBanner1: 'http://design.kitaas.edu.pk/images/intro-back.jpeg',
  icon: 'http://design.kitaas.edu.pk/images/favicon.ico',
